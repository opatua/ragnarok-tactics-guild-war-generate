...
urlpatterns = [
    ...
    path('character/create', views.CharacterCreateView.as_view(),
         name='character_create'),
    path('character/<slug:pk>/update',
         views.CharacterUpdateView.as_view(), name='character_update'),
    path('character/<slug:pk>/delete',
         views.CharacterDeleteView.as_view(), name='character_delete'),

    path('guild-war-character/data', views.GuildWarCharacterDataView.as_view(),
         name='guild_war_character_data'),
    path('guild-war-character', views.GuildWarCharacterListView.as_view(),
         name='guild_war_character_index'),
    path('guild-war-character/create', views.GuildWarCharacterCreateView.as_view(),
         name='guild_war_character_create'),
    path('guild-war-character/<slug:pk>/update',
         views.GuildWarCharacterUpdateView.as_view(), name='guild_war_character_update'),
    path('guild-war/suggestion', views.GuildWarSuggestionView.as_view(),
         name='guild_war_suggestion'),
    ...
    path('monster/<slug:pk>/update',
         views.MonsterUpdateView.as_view(), name='monster_update'),
    path('monster/<slug:pk>/delete',
         views.MonsterDeleteView.as_view(), name='monster_delete'),
    ...
    path('resonance/create', views.ResonanceCreateView.as_view(),
         name='resonance_create'),
    path('resonance/<slug:pk>/update',
         views.ResonanceUpdateView.as_view(), name='resonance_update'),
    path('resonance/<slug:pk>/delete',
         views.ResonanceDeleteView.as_view(), name='resonance_delete'),
